# Salary Insights & Prediction Dashboard | Power BI Project

### **Link to Live Interactive DashBoard**: [Power BI DashBoard](https://app.powerbi.com/view?r=eyJrIjoiZGVmZTdmMDAtZDQ3Yy00MTM1LWFmZmQtYWJhNGUzZDEyNGJmIiwidCI6ImM2ZTU0OWIzLTVmNDUtNDAzMi1hYWU5LWQ0MjQ0ZGM1YjJjNCJ9)

# Project Overview
In today’s data-driven job market, understanding the variables that dictate compensation is crucial for both employers and job seekers. This project involved developing a comprehensive, multi-page Power BI Dashboard that analyzes a dataset of 250,000 job records  to uncover salary trends, key drivers, and remote work shifts.
...
- Data Source: 250,000 Job Records 
- DAX: Implemented for complex KPI calculations (Avg/Max/Min Salaries).
- Data Modeling: Created a star schema to handle global filters across Job Title, Industry, and Location.

# Business Value
- This dashboard enables HR professionals and recruiters to:
  
- Benchmark Salaries: Align internal pay scales with market averages based on specific certifications and experience.

- Strategic Hiring: Identify high-demand, high-cost roles like AI and Cloud Engineering to optimize recruitment budgets.

- Workforce Planning: Understand the financial implications and industry standards of adopting remote vs. onsite work models.
